...
//        
//        typealias SelectionControllerEmployee = EmployeeListLayoutOutputImp<Employee>
//        
...
//            let employeeListLayoutOutput = EmployeeListLayoutOutputImp(closure: employeeSellectionClosure)
//            
